...
public class EchoClient {
    ...
    public EchoClient(GearmanJobServerConnection conn) {
    ...
    public String echo(String input) {
        String function = EchoFunction.class.getCanonicalName();
    ...
    public static void main(String[] args) {
        ...
        EchoClient rc = new EchoClient(host, port);
        System.out.println(rc.echo(payload));                                //NOPMD
        rc.shutdown();
    }

    public static void usage() {
        String[] usage = {
            "usage: org.gearman.example.EchoClient [-h<host>] [-p<port>] " +
                    "<string>",
            "\t-h<host> - job server host",
            "\t-p<port> - job server port",
            "\n\tExample: java org.gearman.example.EchoClient Foo",
            "\tExample: java org.gearman.example.EchoClient -h127.0.0.1 " +
                    "-p4730 Bar", //
        };
